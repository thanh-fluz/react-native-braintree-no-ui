...
public class Braintree extends ReactContextBaseJavaModule {
  ...
  public void setup(final String token, final Callback successCallback,
    ...
    try {
      this.mBraintreeFragment = BraintreeFragment.newInstance(
          (AppCompatActivity)getCurrentActivity(), token);
  ...
  @ReactMethod
  public void getCardNonce(final ReadableMap parameters,
    ...
    // expirationMonth and exporationYear, accept rather expirationDate (which
    // is combination of expirationMonth/expirationYear)
    ...
    ThreeDSecure.performVerification(this.mBraintreeFragment, cardBuilder,
